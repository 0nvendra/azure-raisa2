...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('login-form/fonts/iconic/css/material-design-iconic-font.min.css') }}">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-7">
                    <div class="login-wrap">
                        <form action="{{ route('payroll-login') }}" method="post" class="signin-form d-md-flex">
                            {{ csrf_field() }}
                            <div class="half p-4 py-md-5">
                                ...
                                <div class="form-group">
                                    <button type="submit"
                                        class="form-control btn btn-secondary rounded submit px-3">Masuk</button>
                                </div>
                            </div>
                            <!--<div class="half p-4 py-md-5" style="background-color:#17223b;">-->
                            <div class="half p-4 py-md-5"
                                style="background-image:url('uploads/iStock-582256640.jpg'); background-repeat: no-repeat;
					background-size: cover;opacity:1;">
                                <p>
                                    <center>
                                        <img src="{{ asset('uploads/Azure-4a_Transparent_alt_TRIM.png') }}"
                                            width="50%" height="50%">
                                        <br>
                                        <br>
                                ...
                                <p class="w-100 text-center" style="color:white;"> <i>Payroll system
                                        administration</i> </p>
                                <div class="w-100">
