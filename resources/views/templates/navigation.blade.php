...
<header class="main-header">
  ...
  <a href="{{ url('') }}" class="logo">
    ...
    <span class="logo-mini"><b>RAISA</b></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>RAI</b>SA</span>
  ...
  <nav class="navbar navbar-static-top">
    ...
    <span class="logo-mini"><b>RAISA</b></span>
    <!-- logo for regular state and mobile devices -->
    <span><b>Azure Investama Grup</b></span>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <img src="{{ asset('AdminLTE-2.3.11/dist/img/thumbnail-aig.png') }}" class="user-image" alt="User Image">
          @else
          <?php 
  ...
  <section class="sidebar">
    ...
    <div class="user-panel" style="padding:15px 10px 75px 10px !important;">
      ...
      <div class="pull-left image">
        @if(Auth::user()->role_id == 1 || Auth::user()->role_id == 10 || Auth::user()->role_id == 11 || Auth::user()->role_id == 12)
            <img src="{{ asset('AdminLTE-2.3.11/dist/img/thumbnail-aig.png') }}" class="img-circle" alt="User Image">
          @else
          <?php 
            $foto = Auth::user()->user_login->foto;
          ?>
    ...
    <!--{{-- ROLE KARYAWAN --}}-->
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-user"></i> <span>Human CC</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
              ...
              <li class="treeview">
               ...
               <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="#"><i class="fa fa-check-circle-o"></i> CFIT
                      <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                      </span>
                    </a>
                    <ul class="treeview-menu">
                      ...
                      <ul class="treeview-menu">
                        <li><a href="{{url('kategori-cfit')}}"><i class="fa fa-minus fa-sm"></i>Category</a></li>
                        <li><a href="{{url('statement-cfit')}}"><i class="fa fa-minus fa-sm"></i>Statement</a></li>
                      </ul>
                      </li>
                      <li><a href="{{url('report-cfit')}}"><i class="fa fa-bar-chart"></i>Report</a></li>
                    </ul>
                  </li>
