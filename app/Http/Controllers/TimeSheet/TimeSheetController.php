...
class TimeSheetController extends Controller
{
    ...
    public function timesheetHO(){
        ...
        $first_off      = $this_year."-".$lastMonth."-"."23";
        $last_cut_off   = $this_year."-".$next_month."-"."22";
        ...
        $first_off2      = "23"."/".$lastMonth."/".$this_year;
        $last_cut_off2   = "22"."/".$next_month."/".$this_year;;
...
//   --------------------TIMESHEET PROJECT----------------------------------------
    ...
    public function FilterSummary(Request $request){
        ...
        $first_off      = $get_year."-"."0".$lastMonth."-"."23";
        $last_cut_off   = $get_year."-".$get_month."-"."22";
    ...
    public function downloadSummaryTimesheetPersonal(Request $request){
        ...
        $first_off      = $years."-".$ls_month."-"."23";
        $last_cut_off   = $years."-".$month."-"."22";
